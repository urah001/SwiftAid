  ...
  const handleResolveEmergency = async () => {
    ...
    try {
      const response = await fetch(
        `/api/emergency/resolve/${selectedEmergency.id}`,
        {
          method: "PUT",
        }
      );
      ...
      if (response.ok) {
        ...
        setActiveEmergencies(
          activeEmergencies.filter((e) => e.id !== selectedEmergency.id)
        );
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Monitor and respond to campus medical emergencies
        </p>
      </div>
          ...
          <CardContent>
            {activeEmergencies.length > 0 ? (
                    ...
                    <div className="bg-red-100 dark:bg-red-900/20 px-4 py-2 flex justify-between items-center">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium">
                          Reported: {formatTimestamp(emergency.createdAt)}
                        </span>
                      </div>
                      <Button
                        size="sm"
              ...
              <div className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="text-muted-foreground">
                  All reported emergencies have been resolved
                </p>
              </div>
            )}
          </CardContent>
